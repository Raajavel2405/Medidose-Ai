      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white rounded-lg shadow p-6 text-center">
            ...
            <p className="text-indigo-700 mb-4">Chief Medical Officer</p>
            <p className="text-gray-600">
              Board-certified physician with expertise in pharmacology and precision medicine.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow p-6 text-center">
            <div className="mb-4">
            ...
            <p className="text-indigo-700 mb-4">Lead AI Researcher</p>
            <p className="text-gray-600">
              PhD in Machine Learning focused on healthcare applications and predictive modeling.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow p-6 text-center">
            <div className="mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-1">Elena Rodriguez</h3>
          ...
          <div className="bg-white rounded-lg shadow p-6 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-1">Alex Thompson</h3>
